                        ...
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            <div class="brand-logo">
                                ...
                                <span class="fw-bold " style="font-family: Sofia,sans-serif;"> <span
                                        class="fs-1 font-effect-shadow-multiple">Advance</span> <span
                                        class="text-primary fs-4 font-effect-shadow-multiple"> File Management System</span> </span>
                            </div>
                          ...
                          ?>
                                ...
                                <div class="my-2 d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="#" class="auth-conn text-black"></a>
                                </div>
                                <div class="mb-2">
